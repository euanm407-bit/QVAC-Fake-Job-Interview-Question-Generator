# QVAC Fake Job Interview Question Generator

Type a job title and an on-device AI writes an oddly specific, slightly absurd interview question for it, with a deterministic weirdness meter.
...
Then open http://localhost:29386
